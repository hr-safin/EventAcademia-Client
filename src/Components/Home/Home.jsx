...
const Home = () => {
    return (
        <div  className=''>
        <div 
        className=' bg-white dark:bg-slate-900 lg:my-0 dark:my-0 dark:pt-32 lg:pt-20 lg:pb-16 pt-36 dark:mb-0  px-6 lg:pl-32 lg:pr-10 lg:h-[100vh] md:px-10 flex flex-col lg:flex-row justify-center gap-20 lg:gap-44 items-center'>
            <div>
