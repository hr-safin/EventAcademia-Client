...
const About = () => {
    return (
        <div 
        className=' bg-whit  dark:bg-slate-900 lg:py-0 py-20   dark:mx-0 lg:mt-0 dark:mt-0 lg:mb-0 dark:mb-0   px-6 lg:pl-32 lg:pr-10 lg:h-[100vh] md:px-10 flex flex-col lg:flex-row-reverse justify-center gap-16 md:gap-20 lg:gap-16'>
            <div  className=' '>
